...
return [
    ...
    'resitutionRemove' => [['id'], ['_controller' => 'App\\Controller\\DashboardController::resitutionRemove'], [], [['variable', '/', '[^/]++', 'id', true], ['text', '/restitution/Delete']], [], []],
    'restitutionAccept' => [['id'], ['_controller' => 'App\\Controller\\DashboardController::restitutionAccept'], [], [['variable', '/', '[^/]++', 'id', true], ['text', '/restitution/Accept']], [], []],
    ...
    'DeleteNotification' => [[], ['_controller' => 'App\\Controller\\HomePageController::DeleteNotification'], [], [['text', '/DeleteNotification']], [], []],
    ...
    'restitution' => [[], ['_controller' => 'App\\Controller\\RestitutionController::index'], [], [['text', '/restitution']], [], []],
    'DemandeRestitution' => [['id'], ['_controller' => 'App\\Controller\\RestitutionController::demande'], [], [['variable', '/', '[^/]++', 'id', true], ['text', '/DemandeRestitution']], [], []],
