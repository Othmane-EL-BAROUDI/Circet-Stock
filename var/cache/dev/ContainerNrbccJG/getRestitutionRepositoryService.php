...
// Returns the private 'App\Repository\RestitutionRepository' shared autowired service.
...
include_once $this->targetDirs[3].'\\src\\Repository\\RestitutionRepository.php';

return $this->privates['App\\Repository\\RestitutionRepository'] = new \App\Repository\RestitutionRepository(($this->services['doctrine'] ?? $this->getDoctrineService()));
