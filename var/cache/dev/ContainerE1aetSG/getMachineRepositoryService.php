...
// Returns the private 'App\Repository\MachineRepository' shared autowired service.
...
include_once $this->targetDirs[3].'\\src\\Repository\\MachineRepository.php';

return $this->privates['App\\Repository\\MachineRepository'] = new \App\Repository\MachineRepository(($this->services['doctrine'] ?? $this->getDoctrineService()));
