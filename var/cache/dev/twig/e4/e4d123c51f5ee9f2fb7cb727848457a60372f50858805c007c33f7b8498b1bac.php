...
\t\t\t\t\t\t";
        // line 83
        $context['_parent'] = $context;
        $context['_seq'] = twig_ensure_traversable((isset($context["allRoles"]) || array_key_exists("allRoles", $context) ? $context["allRoles"] : (function () { throw new RuntimeError('Variable "allRoles" does not exist.', 83, $this->source); })()));
...
\t\t\t\t\t\t\t\t\t";
            // line 86
            echo twig_escape_filter($this->env, twig_get_attribute($this->env, $this->source, $context["role"], "roleName", [], "any", false, false, false, 86), "html", null, true);
            echo "
\t\t\t\t\t\t\t\t</td>
...
\t\t\t\t\t\t\t\t\t<a href=\"Role/Edit/";
            // line 91
            echo twig_escape_filter($this->env, twig_get_attribute($this->env, $this->source, $context["role"], "id", [], "any", false, false, false, 91), "html", null, true);
            echo "\">
...
\t\t\t\t\t\t\t\t\t<button type=\"button\" class=\"bn3 btn  btn-sm btn-rounded mt-1 \" data-toggle=\"modal\" data-target=\"#exampleModal";
            // line 97
            echo twig_escape_filter($this->env, twig_get_attribute($this->env, $this->source, $context["role"], "id", [], "any", false, false, false, 97), "html", null, true);
...
\t\t\t\t\t\t\t<div class=\"modal fade\" id=\"exampleModal";
            // line 103
            echo twig_escape_filter($this->env, twig_get_attribute($this->env, $this->source, $context["role"], "id", [], "any", false, false, false, 103), "html", null, true);
...
\t\t\t\t\t\t\t\t\t\t\t<label style=\"  font-weight: bold; color: #f9a826; \">";
            // line 114
            echo twig_escape_filter($this->env, twig_get_attribute($this->env, $this->source, $context["role"], "roleName", [], "any", false, false, false, 114), "html", null, true);
            echo "</label>
\t\t\t\t\t\t\t\t\t\t</div>
\t\t\t\t\t\t\t\t\t\t<div class=\"modal-footer\">
\t\t\t\t\t\t\t\t\t\t\t<a href=\"Role/Remove/";
...
";
    ...
    {
        return array (  315 => 134,  308 => 133,  295 => 126,  280 => 117,  274 => 114,  260 => 103,  251 => 97,  242 => 91,  234 => 86,  230 => 84,  226 => 83,  201 => 60,  189 => 54,  186 => 53,  181 => 52,  169 => 46,  165 => 44,  160 => 43,  148 => 37,  144 => 35,  140 => 34,  132 => 29,  124 => 24,  119 => 22,  106 => 11,  99 => 10,  88 => 6,  81 => 5,  67 => 2,  60 => 133,  58 => 10,  54 => 9,  52 => 5,  49 => 4,  47 => 2,  44 => 1,);
    }
